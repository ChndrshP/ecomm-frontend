...
const LoginPage = () => {
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <Header />
            {/* Main Content */}
            <main className="flex-grow grid grid-cols-2 gap-8 max-w-7xl mx-auto py-12 px-6">
                {/* Left Side - Image */}
                <div className="bg-[#C1DBE3]">
                    <img src="/path-to-your-shopping-image.jpg" alt="Shopping Cart with Phone" className="w-full h-full object-cover" />
                </div>
